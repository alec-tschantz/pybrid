...
class Layer(nn.Module):
    def __init__(
        self, in_size, out_size, act_fn, use_bias=False, kaiming_init=False, is_amortised=False
    ):
        super().__init__()
        ...
        self.is_amortised = is_amortised
...
class FCLayer(Layer):
    def __init__(
        ...
        super().__init__(in_size, out_size, act_fn, use_bias, kaiming_init, is_amortised=is_amortised)
        self.use_bias = use_bias
        self.inp = None
